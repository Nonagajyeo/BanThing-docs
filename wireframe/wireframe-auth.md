...
![로그인 페이지](../assets/img/wireframe/v1.0.0/wireframe-auth-01-20250909.png)
...
| 1-2 | 버튼 | (Should) 네이버로 시작하기 | 클릭 시 네이버 인증을 시작합니다. (UI상 '로그인' 또는 '시작하기' 등으로 표현) |
| 1-3 | 버튼 | (Should) 구글로 시작하기  | 클릭 시 구글 인증을 시작합니다. (UI상 '로그인' 또는 '시작하기' 등으로 표현)  |
...
![약관동의 모달](../assets/img/wireframe/v1.0.0/wireframe-auth-02-20250909.png)
...
| 버전 | 날짜 | 변경 내용 | 작성자 |
| ------ | ----------- | -------------- |-----|
| v1.1.1 | 2025.09.20 | 소셜 로그인 선택지 확장 및 상세 설명 개선 | 고동현 |
