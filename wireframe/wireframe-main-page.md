...
![메인 페이지](../assets/img/wireframe/v2.0.0/wireframe-mian-20250920.png)
...
| 2-3   | 스크롤   | 페이지네이션     | 스크롤이 페이징 버튼을 누를 시 다음 페이지로 넘어갑니다.                                 |
...
### 3.3. [MAIN-002] AI 챗봇 모달

- **화면 설명**: 사용자가 자연어 질의를 통해 원하는 조건의 모임을 대화 형태로 검색할 수 있는 AI 기반 보조 기능입니다.

- **와이어프레임**:

![챗봇 모달](../assets/img/wireframe/v2.0.0/wireframe-main-chatbot-20250920.png%20.png)
