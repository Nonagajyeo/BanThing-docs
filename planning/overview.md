...
본 문서는 **전반적인 개요, 팀 정체성, 그리고 핵심 기능**을 정리한 문서입니다. 저희가 지향하는 서비스 방향성과 구현 목표를 팀 전체가 공유할 수 있도록 작성되었습니다.
...
* **카카오 지도 기반 탐색**: 카카오 지도 API를 통해 마트 지점별로 예정된 소분 파티를 직관적으로 확인.
...
* **피드백 시스템**: 모임 종료 후 참여자들은 서로에 대한 피드백을 남길 수 있으며, 이는 사용자의 신뢰도를 나타내는 지표로 활용.

## 변경 이력

| 버전     | 날짜         | 변경 내용                 | 작성자 |
|--------|------------|-----------------------|-----|
| v1.1.0 | 2025.09.22 | 카카오 SSO,피드백 주요 특징에 추가 | 고동현 |
